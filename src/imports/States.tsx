...
function Group28() {
  return (
    <div className="absolute contents inset-[33.79%_4.17%_64.14%_4.17%]">
      <Group11 />
      <Group12 />
      <Group13 />
...
function Group28Copy() {
  return (
    <div className="absolute contents inset-[46.21%_4.17%_51.72%_4.17%]" data-name="Group 28 Copy">
      <Group14 />
      <Group15 />
      <Group16 />
...
function SurfaceContainers() {
  return (
    ...
    >
      ...
      <StickersheetTypographyDCaptionMediumBlackCopy16 />
      <StickersheetTypographyDCaptionMediumBlackCopy17 />
...
function Labels1() {
  return (
    <div className="absolute contents inset-[75.69%_4.17%_22.24%_4.17%]" data-name="Labels">
      <Group17 />
      <Group18 />
...
function StructureDiagram() {
  return (
    ...
    >
      ...
      <div className="absolute flex inset-[24.18%_64.51%_75.78%_22.92%] items-center justify-center">
      ...
      <div className="absolute flex inset-[25.47%_64.51%_74.44%_24.65%] items-center justify-center">
...
function Arrow() {
  return (
    <div className="absolute inset-[20.82%_29.24%_77.84%_70.14%]" data-name="Arrow">
...
function Arrow1() {
  return (
    <div className="absolute inset-[24.05%_29.24%_74.61%_70.14%]" data-name="Arrow">
      <div className="absolute bottom-[-0.76%] left-0 right-0 top-[-1.61%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 9 33">
          <g id="Arrow">
            <path
...
export default function States() {
  return (
    <div className="bg-[#292929] relative size-full" data-name="States">
      <Labels />
      <SurfaceContainers />
      <PrimaryContainers />
      <StructureDiagram />
