...
import { ENVIRONMENT_PROFILES, type EnvironmentProfileType } from '../config/environmentProfiles';
...
export function EnvironmentProfileSelector({
  ...
  const currentProfile =
    ENVIRONMENT_PROFILES[ctx.environmentProfile.id] || ENVIRONMENT_PROFILES.CAMPUS;
  ...
  return (
    <>
            ...
            return (
              <DropdownMenuItem
                ...
                className={cn(
                  ...
                  isAI &&
                    'bg-gradient-to-r from-purple-500/10 to-blue-500/10 border-b border-purple-500/20'
                )}
              >
                <ProfileIcon
                  className={cn(
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2">
                    ...
                    {isAI && (
                      <Badge className="text-xs px-1.5 h-4 bg-purple-500/20 text-purple-400 border-purple-500/30">
                        Auto
                      </Badge>
                    )}
                    ...
                    <div className="mt-2 space-y-1.5">
                      ...
                      {showThresholds && aiBaselineSummary.sampleCount > 0 && (
                        <div className="flex flex-wrap gap-1 mt-1">
                          <Badge
                            variant="outline"
                            className="text-xs px-1 h-4 border-purple-500/30 text-purple-400"
                          >
      ...
      <ContextConfigModal open={contextModalOpen} onOpenChange={setContextModalOpen} />
    </>
  );
}
