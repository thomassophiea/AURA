    ...
    return (
      <div className="flex flex-col items-center justify-center h-full gap-3 px-6 text-center">
        ...
        <div className="flex flex-col gap-1">
          <p className="text-sm text-muted-foreground">No active execution plan</p>
          <p className="text-xs text-muted-foreground/60">
            Ask Chat to perform a network operation — AURA will build and stage a plan here before
            executing.
          </p>
        </div>
      </div>
