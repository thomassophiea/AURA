  ...
  return (
    <Card className={cn('', className)}>
      <CardHeader className="pb-3">
        ...
        <CardDescription>
          {summary.total} insight{summary.total !== 1 ? 's' : ''} for {profile.name} • Ranked by
                          ...
                          <div className="flex items-center gap-2 flex-wrap">
                            ...
                            {insight.trend && (
                              <Badge
                                variant="outline"
                                className={cn(
                                  'text-xs px-1.5 h-4 gap-0.5',
                                  insight.trend.direction === 'improving' &&
                                    'border-[color:var(--status-success)]/20 text-[color:var(--status-success)]',
                                  insight.trend.direction === 'degrading' &&
                                    'border-[color:var(--status-error)]/20 text-[color:var(--status-error)]',
                            ...
                            {insight.prediction && (
                              <Badge
                                variant="outline"
                                className="text-xs px-1.5 h-4 gap-0.5 border-purple-500/50 text-purple-600"
                              >
                        ...
                        <div className="flex items-center gap-2">
                          <div className="text-right">
                            ...
                            <p className="text-sm font-semibold">
                              {(insight.rankScore * 100).toFixed(0)}
                            </p>
                          </div>
                          {isExpanded ? (
