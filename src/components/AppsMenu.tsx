...
import { ExternalLink, Network, Activity, Layers, Key } from 'lucide-react';
...
function buildApps(): App[] {
  ...
  return [
    ...
    },
    {
      ...
      name: 'Extreme KeyAI',
      description:
        'AI-powered Personal Pre-Shared Key management with advanced facial recognition and real-time connection monitoring',
      isActive: false,
      isBeta: true,
      icon: Key,
...
export function AppsMenu() {
  ...
  return (
    <Popover open={isOpen} onOpenChange={setIsOpen}>
      ...
      <PopoverContent className="w-72 p-0 border-border/50" align="end" sideOffset={8}>
        <div className="p-4">
          {/* Header */}
          <div className="mb-4">
          ...
          <div className="mt-4 pt-3 border-t border-border/50">
            <div className="text-xs text-muted-foreground text-center">{branding.name}</div>
          </div>
        </div>
      </PopoverContent>
    </Popover>
