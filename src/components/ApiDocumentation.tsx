...
const apiCategories: ApiCategory[] = [
    ...
    endpoints: [
      {
        ...
        description: 'Login and obtain access token with grantType, userId, and password',
      },
      {
        method: 'DELETE',
        path: '/v1/oauth2/token/{token}',
        description: 'Revoke/logout an access token',
        parameters: ['token'],
      },
      {
        method: 'POST',
        path: '/v1/oauth2/refreshToken',
        description: 'Refresh an expired access token using refresh_token',
      },
      {
        method: 'POST',
        path: '/v1/oauth2/introspecttoken',
        description: 'Validate and get info about an access token',
      },
    ],
  },
  {
    ...
    endpoints: [
      {
        method: 'GET',
        path: '/v1/aps',
        description: 'Get list of all access points with optional brief/inventory parameters',
      },
      {
        method: 'GET',
        path: '/v1/aps/{apSerialNumber}',
        description: 'Get access point by serial number',
        parameters: ['apSerialNumber'],
      },
      {
        method: 'PUT',
        path: '/v1/aps/{apSerialNumber}',
      ...
      },
      {
        method: 'GET',
        path: '/v1/aps/query',
        description: 'Get filtered list of access points based on query',
      },
      {
        method: 'GET',
        path: '/v1/aps/query/columns',
        description: 'Get available query columns for AP filtering',
      },
      {
        method: 'GET',
        path: '/v1/aps/query/visualize',
        description: 'Get filtered AP list with visualization columns',
      },
      {
        method: 'GET',
        path: '/v1/aps/{apserialnum}/stations',
        description: 'Get stations connected to specific AP',
        parameters: ['apserialnum'],
      },
      {
        method: 'GET',
        path: '/v1/aps/{apserialnum}/lldp',
        description: 'Get LLDP neighbor information',
        parameters: ['apserialnum'],
      },
      {
        method: 'GET',
        path: '/v1/aps/{apSerialNumber}/bssid0',
        description: 'Get BSSID information for AP',
        parameters: ['apSerialNumber'],
      },
      {
        method: 'GET',
        path: '/v1/aps/{apSerialNumber}/location',
        description: 'Get AP location info',
        parameters: ['apSerialNumber'],
      },
      {
        method: 'PUT',
        path: '/v1/aps/{apSerialNumber}/location',
        description: 'Update AP location',
        parameters: ['apSerialNumber'],
      },
      {
        method: 'GET',
        path: '/v1/aps/{apSerialNumber}/logs',
        description: 'Get AP diagnostic logs',
        parameters: ['apSerialNumber'],
      },
      {
        method: 'GET',
        path: '/v1/aps/{apSerialNumber}/traceurls',
        description: 'Get trace URLs for AP',
        parameters: ['apSerialNumber'],
      },
      {
        method: 'POST',
        path: '/v1/aps/{apSerialNumber}/reboot',
        description: 'Reboot an access point',
        parameters: ['apSerialNumber'],
      },
      {
        method: 'POST',
        path: '/v1/aps/{apSerialNumber}/reset',
        description: 'Factory reset an access point',
        parameters: ['apSerialNumber'],
      },
      {
        method: 'POST',
        path: '/v1/aps/{apSerialNumber}/upgrade',
        description: 'Upgrade AP firmware',
        parameters: ['apSerialNumber'],
      },
      {
        method: 'POST',
        path: '/v1/aps/{apSerialNumber}/locate',
        description: 'Trigger AP LED locator',
        parameters: ['apSerialNumber'],
      },
      {
        method: 'POST',
        path: '/v1/aps/{apSerialNumber}/realcapture',
        description: 'Start real-time packet capture',
        parameters: ['apSerialNumber'],
      },
      {
        method: 'POST',
        path: '/v1/aps/{apSerialNumber}/copytodefault',
        description: 'Copy AP config to default profile',
        parameters: ['apSerialNumber'],
      },
      {
        method: 'POST',
        path: '/v1/aps/{apSerialNumber}/setRuState',
        description: 'Set regulatory unit state',
        parameters: ['apSerialNumber'],
      },
      {
        method: 'GET',
        path: '/v1/aps/{apSerialNumber}/cert',
        description: 'Get AP certificate info',
        parameters: ['apSerialNumber'],
      },
      {
        method: 'GET',
        path: '/v1/aps/{apSerialNumber}/report',
        description: 'Get AP performance report',
        parameters: ['apSerialNumber'],
      },
      { method: 'GET', path: '/v1/aps/list', description: 'Get lightweight list of all APs' },
      {
        method: 'GET',
        path: '/v1/aps/default',
        description: 'Get default AP configuration template',
      },
      {
        method: 'PUT',
        path: '/v1/aps/default',
        description: 'Update default AP configuration template',
      },
      ...
      {
        method: 'POST',
        path: '/v1/aps/multiconfig',
        description: 'Apply configuration to multiple APs',
      },
      ...
      {
        method: 'POST',
        path: '/v1/aps/releasetocloud',
        description: 'Release APs to cloud management',
      },
      { method: 'GET', path: '/v1/aps/displaynames', description: 'Get display names for all APs' },
      {
        method: 'GET',
        path: '/v1/aps/hardwaretypes',
        description: 'Get supported AP hardware types',
      },
      ...
      { method: 'GET', path: '/v1/aps/swversion', description: 'Get current software versions' },
      {
        method: 'GET',
        path: '/v1/aps/ifstats',
        description: 'Get interface statistics for all APs',
      },
      {
        method: 'GET',
        path: '/v1/aps/ifstats/{apSerialNumber}',
        description: 'Get interface statistics for specific AP',
        parameters: ['apSerialNumber'],
      },
      ...
      {
        method: 'GET',
        path: '/v1/aps/upgradeimagelist',
        description: 'Get available firmware images',
      },
      ...
      {
        method: 'GET',
        path: '/v1/aps/downloadtrace/{filename}',
        description: 'Download trace file',
        parameters: ['filename'],
      },
      {
        method: 'GET',
        path: '/v1/aps/antenna/{apSerialNumber}',
      ...
      },
      {
        method: 'PUT',
        path: '/v1/aps/antenna/{apSerialNumber}',
        description: 'Update antenna configuration',
        parameters: ['apSerialNumber'],
      },
      ...
      {
        method: 'POST',
        path: '/v1/aps/cert/signrequest',
        description: 'Create certificate signing request',
      },
      {
        method: 'GET',
        path: '/v1/ap/environment/{apSerialNumber}',
        description: 'Get AP environment info',
        parameters: ['apSerialNumber'],
      },
    ],
  },
    ...
    endpoints: [
      {
        method: 'GET',
        path: '/v1/stations',
        description: 'Get list of all connected stations/clients',
      },
      {
        method: 'GET',
        path: '/v1/stations/{macaddress}',
        description: 'Get station details by MAC address',
        parameters: ['macaddress'],
      },
      {
        method: 'DELETE',
        path: '/v1/stations/{macaddress}',
        description: 'Delete station record',
        parameters: ['macaddress'],
      },
      { method: 'GET', path: '/v1/stations/query', description: 'Query stations with filters' },
      {
        method: 'GET',
        path: '/v1/stations/query/columns',
        description: 'Get available query columns for stations',
      },
      {
        method: 'GET',
        path: '/v1/stations/query/visualize',
        description: 'Get stations with visualization data',
      },
      {
        method: 'GET',
        path: '/v1/stations/{stationId}/location',
        description: 'Get station location',
        parameters: ['stationId'],
      },
      {
        method: 'GET',
        path: '/v1/stations/{stationId}/report',
        description: 'Get station performance report',
        parameters: ['stationId'],
      },
      {
        method: 'GET',
        path: '/v1/stations/events/{macaddress}',
        description: 'Get station events history',
        parameters: ['macaddress'],
      },
      {
        method: 'POST',
        path: '/v1/stations/disassociate',
        description: 'Disassociate/disconnect a station',
      },
    ],
  },
  {
    ...
    endpoints: [
      ...
      {
        method: 'PUT',
        path: '/v3/sites/default',
        description: 'Update default site configuration',
      },
      { method: 'GET', path: '/v3/sites/nametoidmap', description: 'Get site name to ID mapping' },
      {
        method: 'POST',
        path: '/v3/sites/clone/{siteId}',
        description: 'Clone site configuration',
        parameters: ['siteId'],
      },
      { method: 'GET', path: '/v3/sites/countrylist', description: 'Get supported country codes' },
      {
        method: 'GET',
        path: '/v3/sites/{siteid}/stations',
        description: 'Get stations at site',
        parameters: ['siteid'],
      },
      {
        method: 'GET',
        path: '/v3/sites/{siteId}/report/venue',
        description: 'Get venue statistics report',
        parameters: ['siteId'],
      },
      {
        method: 'GET',
        path: '/v3/sites/{siteId}/report/impact',
        description: 'Get site impact report',
        parameters: ['siteId'],
      },
      { method: 'GET', path: '/v3/sites/report', description: 'Get report across all sites' },
      {
        method: 'GET',
        path: '/v3/sites/report/flex',
        description: 'Get flexible time range report',
      },
      {
        method: 'GET',
        path: '/v3/sites/report/venue',
        description: 'Get venue report for all sites',
      },
      {
        method: 'GET',
        path: '/v3/sites/report/impact',
        description: 'Get impact report for all sites',
      },
      {
        method: 'GET',
        path: '/v3/sites/report/location/floor/{floorId}',
        description: 'Get floor location report',
        parameters: ['floorId'],
      },
      {
        method: 'GET',
        path: '/v1/sites/{siteId}/report',
        description: 'Get site report (v1 API)',
        parameters: ['siteId'],
      },
      {
        method: 'GET',
        path: '/v1/msp/briefsites/{tenantId}',
        description: 'Get brief sites for MSP tenant',
        parameters: ['tenantId'],
      },
    ],
  },
  {
    ...
    endpoints: [
      ...
      {
        method: 'GET',
        path: '/v1/services/default',
        description: 'Get default service configuration',
      },
      {
        method: 'PUT',
        path: '/v1/services/default',
        description: 'Update default service configuration',
      },
      {
        method: 'GET',
        path: '/v1/services/nametoidmap',
        description: 'Get service name to ID mapping',
      },
      {
        method: 'GET',
        path: '/v1/services/{serviceId}/stations',
        description: 'Get stations connected to service',
        parameters: ['serviceId'],
      },
      {
        method: 'GET',
        path: '/v1/services/{serviceId}/report',
        description: 'Get service performance report',
        parameters: ['serviceId'],
      },
      {
        method: 'GET',
        path: '/v1/services/{serviceid}/bssid0',
        description: 'Get BSSIDs for service',
        parameters: ['serviceid'],
      },
      {
        method: 'GET',
        path: '/v1/services/{serviceId}/deviceids',
        description: 'Get device IDs using service',
        parameters: ['serviceId'],
      },
      {
        method: 'GET',
        path: '/v1/services/{serviceId}/siteids',
        description: 'Get site IDs using service',
        parameters: ['serviceId'],
      },
    ],
  },
  {
    ...
    endpoints: [
      ...
      {
        method: 'GET',
        path: '/v3/profiles/nametoidmap',
        description: 'Get profile name to ID mapping',
      },
      {
        method: 'GET',
        path: '/v3/profiles/{profileId}/bssid0',
        description: 'Get BSSIDs for profile',
        parameters: ['profileId'],
      },
      {
        method: 'GET',
        path: '/v3/profiles/{profileId}/channels',
        description: 'Get profile channel config',
        parameters: ['profileId'],
      },
    ],
  },
  {
    ...
    endpoints: [
      ...
      {
        method: 'PUT',
        path: '/v3/roles/default',
        description: 'Update default role configuration',
      },
      { method: 'GET', path: '/v3/roles/nametoidmap', description: 'Get role name to ID mapping' },
      {
        method: 'GET',
        path: '/v3/roles/{roleId}/rulestats',
        description: 'Get role rule statistics',
        parameters: ['roleId'],
      },
      {
        method: 'GET',
        path: '/v1/roles/{roleId}/report',
        description: 'Get role report',
        parameters: ['roleId'],
      },
      {
        method: 'GET',
        path: '/v1/roles/{roleid}/stations',
        description: 'Get stations with role',
        parameters: ['roleid'],
      },
    ],
  },
  {
    ...
    endpoints: [
      ...
      {
        method: 'GET',
        path: '/v1/switches/{serialNumber}',
        description: 'Get switch by serial number',
      ...
      {
        method: 'POST',
        path: '/v1/switches/{serialNumber}/reboot',
        description: 'Reboot specific switch',
        parameters: ['serialNumber'],
      },
      {
        method: 'POST',
        path: '/v1/switches/{serialNumber}/reset',
        description: 'Factory reset switch',
        parameters: ['serialNumber'],
      },
      {
        method: 'POST',
        path: '/v1/switches/{serialNumber}/upgrade',
        description: 'Upgrade switch firmware',
        parameters: ['serialNumber'],
      },
      {
        method: 'GET',
        path: '/v1/switches/{serialNumber}/logs',
        description: 'Get switch logs',
        parameters: ['serialNumber'],
      },
      {
        method: 'GET',
        path: '/v1/switches/{serialNumber}/traceurls',
        description: 'Get switch trace URLs',
        parameters: ['serialNumber'],
      },
      {
        method: 'GET',
        path: '/v1/switches/{serialNumber}/report',
        description: 'Get switch report',
        parameters: ['serialNumber'],
      },
      {
        method: 'GET',
        path: '/v1/switches/{serialNumber}/clibackups',
        description: 'Get CLI config backups',
        parameters: ['serialNumber'],
      },
      {
        method: 'POST',
        path: '/v1/switches/{serialNumber}/cliconfigs/backup',
        description: 'Create CLI config backup',
        parameters: ['serialNumber'],
      },
      {
        method: 'POST',
        path: '/v1/switches/{serialNumber}/cliconfigs/restore/{name}',
        description: 'Restore CLI config',
        parameters: ['serialNumber', 'name'],
      },
      {
        method: 'PUT',
        path: '/v1/switches/{serialNumber}/configurationmode/{configurationMode}',
        description: 'Set config mode',
        parameters: ['serialNumber', 'configurationMode'],
      },
      {
        method: 'POST',
        path: '/v1/switches/{serialNumber}/console/{consoleAction}',
        description: 'Execute console action',
        parameters: ['serialNumber', 'consoleAction'],
      },
      {
        method: 'POST',
        path: '/v1/switches/{serialNumber}/login',
        description: 'Login to switch console',
        parameters: ['serialNumber'],
      },
      {
        method: 'GET',
        path: '/v1/switches/{serialNumber}/ports/{portNumber}',
      ...
      {
        method: 'GET',
        path: '/v1/switches/{serialNumber}/ports/{portId}/report',
        description: 'Get port report',
        parameters: ['serialNumber', 'portId'],
      },
      {
        method: 'GET',
        path: '/v1/switches/{serialNumber}/slots/{slotNumber}/ports/{portNumber}',
        description: 'Get slot port config',
        parameters: ['serialNumber', 'slotNumber', 'portNumber'],
      },
      {
        method: 'PUT',
        path: '/v1/switches/{serialNumber}/slots/{slotNumber}/ports/{portNumber}',
        description: 'Update slot port config',
        parameters: ['serialNumber', 'slotNumber', 'portNumber'],
      },
    ],
  },
  {
    ...
    endpoints: [
      {
        method: 'GET',
        path: '/v3/switchportprofile',
        description: 'Get list of all port profiles',
      },
      { method: 'POST', path: '/v3/switchportprofile', description: 'Create a new port profile' },
      {
        method: 'GET',
        path: '/v3/switchportprofile/{profileId}',
      ...
      },
      {
        method: 'PUT',
        path: '/v3/switchportprofile/{profileId}',
        description: 'Update port profile',
        parameters: ['profileId'],
      },
      {
        method: 'DELETE',
      ...
      {
        method: 'GET',
        path: '/v3/switchportprofile/default',
        description: 'Get default port profile',
      },
      {
        method: 'GET',
        path: '/v3/switchportprofile/nametoidmap',
        description: 'Get port profile name to ID map',
      },
    ],
  },
  {
    ...
    endpoints: [
      ...
      {
        method: 'GET',
        path: '/v1/state/aps/{apSerialNumber}',
        description: 'Get state of specific AP',
        parameters: ['apSerialNumber'],
      },
      { method: 'GET', path: '/v1/state/sites', description: 'Get state of all sites' },
      {
        method: 'GET',
        path: '/v1/state/sites/{siteId}',
        description: 'Get state of specific site',
        parameters: ['siteId'],
      },
      {
        method: 'GET',
        path: '/v1/state/sites/{siteId}/aps',
        description: 'Get APs state at site',
        parameters: ['siteId'],
      },
      { method: 'GET', path: '/v1/state/switches', description: 'Get state of all switches' },
      {
        method: 'GET',
        path: '/v1/state/switches/{switchSerialNumber}',
        description: 'Get state of specific switch',
        parameters: ['switchSerialNumber'],
      },
      {
        method: 'GET',
        path: '/v1/state/entityDistribution',
        description: 'Get entity distribution stats',
      },
    ],
  },
  {
    ...
    endpoints: [
      ...
      {
        method: 'GET',
        path: '/v1/report/sites/{siteId}',
        description: 'Get specific site report',
        parameters: ['siteId'],
      },
      {
        method: 'GET',
        path: '/v1/report/sites/{siteId}/smartrf',
        description: 'Get SmartRF report',
        parameters: ['siteId'],
      },
      {
        method: 'GET',
        path: '/v1/report/aps/{apSerialNumber}',
        description: 'Get AP report',
        parameters: ['apSerialNumber'],
      },
      {
        method: 'GET',
        path: '/v1/report/aps/{apSerialNumber}/smartrf',
        description: 'Get AP SmartRF report',
        parameters: ['apSerialNumber'],
      },
      {
        method: 'GET',
        path: '/v1/report/stations/{stationId}',
        description: 'Get station report',
        parameters: ['stationId'],
      },
      {
        method: 'GET',
        path: '/v1/report/services/{serviceId}',
        description: 'Get service report',
        parameters: ['serviceId'],
      },
      {
        method: 'GET',
        path: '/v1/report/roles/{roleId}',
        description: 'Get role report',
        parameters: ['roleId'],
      },
      {
        method: 'GET',
        path: '/v1/report/switches/{switchSerialNumber}',
        description: 'Get switch report',
        parameters: ['switchSerialNumber'],
      },
      {
        method: 'GET',
        path: '/v1/report/ports/{portId}',
        description: 'Get port report',
        parameters: ['portId'],
      },
      {
        method: 'GET',
        path: '/v1/report/flex/{duration}',
        description: 'Get flexible duration report',
        parameters: ['duration'],
      },
      {
        method: 'GET',
        path: '/v1/report/location/aps/{apSerialNumber}',
        description: 'Get AP location report',
        parameters: ['apSerialNumber'],
      },
      {
        method: 'GET',
        path: '/v1/report/location/floor/{floorId}',
        description: 'Get floor location report',
        parameters: ['floorId'],
      },
      {
        method: 'GET',
        path: '/v1/report/location/stations/{stationId}',
        description: 'Get station location report',
        parameters: ['stationId'],
      },
      { method: 'GET', path: '/v1/reports/widgets', description: 'Get available report widgets' },
      {
        method: 'GET',
        path: '/v2/report/upgrade/devices',
        description: 'Get device upgrade report',
      },
    ],
  },
  {
    ...
    endpoints: [
      ...
      {
        method: 'GET',
        path: '/v1/reports/templates/{templateId}',
      ...
      {
        method: 'GET',
        path: '/v1/reports/templates/nametoidmap',
        description: 'Get template name to ID map',
      },
    ],
  },
  {
    ...
    endpoints: [
      ...
      {
        method: 'GET',
        path: '/v1/reports/scheduled/default',
        description: 'Get default scheduled report config',
      },
      {
        method: 'GET',
        path: '/v1/reports/scheduled/nametoidmap',
        description: 'Get scheduled report name to ID map',
      },
      {
        method: 'GET',
        path: '/v1/reports/generated',
        description: 'Get list of generated reports',
      },
      {
        method: 'GET',
        path: '/v1/reports/generated/filelist',
        description: 'Get generated report file list',
      },
      {
        method: 'GET',
        path: '/v1/reports/generated/{filename}',
  ...
  },
  {
    ...
    endpoints: [
      ...
      {
        method: 'GET',
        path: '/v1/administrators/{userId}',
        description: 'Get administrator by user ID',
        parameters: ['userId'],
      },
      {
        method: 'PUT',
      ...
      {
        method: 'PUT',
        path: '/v1/administrators/adminpassword',
        description: 'Change admin password',
      },
      {
        method: 'GET',
        path: '/v1/administratorsTimeout/{userId}',
        description: 'Get admin session timeout',
        parameters: ['userId'],
      },
      {
        method: 'PUT',
        path: '/v1/administratorsTimeout/{userId}',
        description: 'Set admin session timeout',
        parameters: ['userId'],
      },
    ],
  },
  {
    ...
    endpoints: [
      ...
      {
        method: 'GET',
        path: '/v1/appkeys/{appKey}',
        description: 'Get application key details',
        parameters: ['appKey'],
      },
      {
        method: 'DELETE',
  ...
  },
  {
    ...
    endpoints: [
      ...
      {
        method: 'GET',
        path: '/v1/aaapolicy/{id}',
        description: 'Get AAA policy by ID',
        parameters: ['id'],
      },
      {
        method: 'PUT',
        path: '/v1/aaapolicy/{id}',
        description: 'Update AAA policy',
        parameters: ['id'],
      },
      {
        method: 'DELETE',
        path: '/v1/aaapolicy/{id}',
        description: 'Delete AAA policy',
        parameters: ['id'],
      },
      { method: 'GET', path: '/v1/aaapolicy/default', description: 'Get default AAA policy' },
      {
        method: 'GET',
        path: '/v1/aaapolicy/nametoidmap',
        description: 'Get AAA policy name to ID map',
      },
    ],
  },
  {
    ...
    endpoints: [
      ...
      { method: 'POST', path: '/v1/cos', description: 'Create a new CoS profile' },
      {
        method: 'GET',
        path: '/v1/cos/{cosId}',
        description: 'Get CoS profile by ID',
        parameters: ['cosId'],
      },
      {
        method: 'PUT',
        path: '/v1/cos/{cosId}',
        description: 'Update CoS profile',
        parameters: ['cosId'],
      },
      {
        method: 'DELETE',
        path: '/v1/cos/{cosId}',
        description: 'Delete CoS profile',
        parameters: ['cosId'],
      },
  ...
  },
  {
    ...
    endpoints: [
      ...
      {
        method: 'GET',
        path: '/v1/ratelimiters/{rateLimiterId}',
        description: 'Get rate limiter by ID',
        parameters: ['rateLimiterId'],
      },
      {
        method: 'PUT',
        path: '/v1/ratelimiters/{rateLimiterId}',
      ...
      {
        method: 'GET',
        path: '/v1/ratelimiters/default',
        description: 'Get default rate limiter config',
      },
      {
        method: 'GET',
        path: '/v1/ratelimiters/nametoidmap',
        description: 'Get rate limiter name to ID map',
      },
    ],
  },
  {
    ...
    endpoints: [
      ...
      {
        method: 'GET',
        path: '/v1/topologies/{topologyId}',
        description: 'Get topology by ID (v1)',
        parameters: ['topologyId'],
      },
      {
        method: 'PUT',
        path: '/v1/topologies/{topologyId}',
        description: 'Update topology (v1)',
        parameters: ['topologyId'],
      },
      {
        method: 'DELETE',
        path: '/v1/topologies/{topologyId}',
        description: 'Delete topology (v1)',
        parameters: ['topologyId'],
      },
      { method: 'GET', path: '/v1/topologies/default', description: 'Get default topology config' },
      {
        method: 'GET',
        path: '/v1/topologies/nametoidmap',
        description: 'Get topology name to ID map',
      },
  ...
  },
  {
    ...
    endpoints: [
      ...
      {
        method: 'GET',
        path: '/v3/rfmgmt/{rfmgmtId}',
        description: 'Get RF policy by ID',
        parameters: ['rfmgmtId'],
      },
      {
        method: 'PUT',
        path: '/v3/rfmgmt/{rfmgmtId}',
        description: 'Update RF policy',
        parameters: ['rfmgmtId'],
      },
      {
        method: 'DELETE',
        path: '/v3/rfmgmt/{rfmgmtId}',
        description: 'Delete RF policy',
        parameters: ['rfmgmtId'],
      },
      { method: 'GET', path: '/v3/rfmgmt/default', description: 'Get default RF policy' },
      {
        method: 'GET',
        path: '/v3/rfmgmt/nametoidmap',
        description: 'Get RF policy name to ID map',
      },
    ],
  },
  {
    ...
    endpoints: [
      ...
      {
        method: 'GET',
        path: '/v3/radios/smartrfchannels',
        description: 'Get SmartRF channel recommendations',
      },
    ],
  },
  {
    ...
    endpoints: [
      ...
      {
        method: 'GET',
        path: '/v3/analytics/{analyticsProfileId}',
        description: 'Get analytics profile by ID',
        parameters: ['analyticsProfileId'],
      },
      {
        method: 'PUT',
        path: '/v3/analytics/{analyticsProfileId}',
        description: 'Update analytics profile',
        parameters: ['analyticsProfileId'],
      },
      {
        method: 'DELETE',
        path: '/v3/analytics/{analyticsProfileId}',
        description: 'Delete analytics profile',
        parameters: ['analyticsProfileId'],
      },
      {
        method: 'GET',
        path: '/v3/analytics/default',
        description: 'Get default analytics profile',
      },
      {
        method: 'GET',
        path: '/v3/analytics/nametoidmap',
        description: 'Get analytics profile name to ID map',
      },
    ],
  },
  {
    ...
    endpoints: [
      ...
      {
        method: 'GET',
        path: '/v3/iotprofile/{iotprofileId}',
        description: 'Get IoT profile by ID',
        parameters: ['iotprofileId'],
      },
      {
        method: 'PUT',
        path: '/v3/iotprofile/{iotprofileId}',
        description: 'Update IoT profile',
        parameters: ['iotprofileId'],
      },
      {
        method: 'DELETE',
        path: '/v3/iotprofile/{iotprofileId}',
        description: 'Delete IoT profile',
        parameters: ['iotprofileId'],
      },
      { method: 'GET', path: '/v3/iotprofile/default', description: 'Get default IoT profile' },
      {
        method: 'GET',
        path: '/v3/iotprofile/nametoidmap',
        description: 'Get IoT profile name to ID map',
      },
    ],
  },
  {
    ...
    endpoints: [
      ...
      {
        method: 'GET',
        path: '/v1/rtlsprofile/{rtlsprofileId}',
        description: 'Get RTLS profile by ID',
        parameters: ['rtlsprofileId'],
      },
      {
        method: 'PUT',
        path: '/v1/rtlsprofile/{rtlsprofileId}',
        description: 'Update RTLS profile',
        parameters: ['rtlsprofileId'],
      },
      {
        method: 'DELETE',
        path: '/v1/rtlsprofile/{rtlsprofileId}',
        description: 'Delete RTLS profile',
        parameters: ['rtlsprofileId'],
      },
      { method: 'GET', path: '/v1/rtlsprofile/default', description: 'Get default RTLS profile' },
      {
        method: 'GET',
        path: '/v1/rtlsprofile/nametoidmap',
        description: 'Get RTLS profile name to ID map',
      },
    ],
  },
  {
    ...
    endpoints: [
      ...
      {
        method: 'GET',
        path: '/v3/positioning/{positioningProfileId}',
        description: 'Get positioning profile by ID',
        parameters: ['positioningProfileId'],
      },
      {
        method: 'PUT',
        path: '/v3/positioning/{positioningProfileId}',
        description: 'Update positioning profile',
        parameters: ['positioningProfileId'],
      },
      {
        method: 'DELETE',
        path: '/v3/positioning/{positioningProfileId}',
        description: 'Delete positioning profile',
        parameters: ['positioningProfileId'],
      },
      {
        method: 'GET',
        path: '/v3/positioning/default',
        description: 'Get default positioning profile',
      },
      {
        method: 'GET',
        path: '/v3/positioning/nametoidmap',
        description: 'Get positioning profile name to ID map',
      },
    ],
  },
  {
    ...
    endpoints: [
      ...
      {
        method: 'GET',
        path: '/v3/xlocation/{xlocationId}',
        description: 'Get ExtremeLocation profile by ID',
        parameters: ['xlocationId'],
      },
      {
        method: 'PUT',
        path: '/v3/xlocation/{xlocationId}',
        description: 'Update ExtremeLocation profile',
        parameters: ['xlocationId'],
      },
      {
        method: 'DELETE',
        path: '/v3/xlocation/{xlocationId}',
        description: 'Delete ExtremeLocation profile',
        parameters: ['xlocationId'],
      },
      {
        method: 'GET',
        path: '/v3/xlocation/default',
        description: 'Get default ExtremeLocation profile',
      },
      {
        method: 'GET',
        path: '/v3/xlocation/nametoidmap',
        description: 'Get ExtremeLocation profile name to ID map',
      },
    ],
  },
  {
    ...
    endpoints: [
      ...
      { method: 'POST', path: '/v3/adsp', description: 'Create an ADSP profile (v3)' },
      {
        method: 'GET',
        path: '/v3/adsp/{adspId}',
        description: 'Get ADSP profile by ID (v3)',
        parameters: ['adspId'],
      },
      {
        method: 'PUT',
        path: '/v3/adsp/{adspId}',
        description: 'Update ADSP profile (v3)',
        parameters: ['adspId'],
      },
      {
        method: 'DELETE',
        path: '/v3/adsp/{adspId}',
        description: 'Delete ADSP profile (v3)',
        parameters: ['adspId'],
      },
      { method: 'GET', path: '/v3/adsp/default', description: 'Get default ADSP profile (v3)' },
      {
        method: 'GET',
        path: '/v3/adsp/nametoidmap',
        description: 'Get ADSP profile name to ID map (v3)',
      },
      ...
      { method: 'POST', path: '/v4/adsp', description: 'Create an ADSP profile (v4)' },
      {
        method: 'GET',
        path: '/v4/adsp/{adspId}',
        description: 'Get ADSP profile by ID (v4)',
        parameters: ['adspId'],
      },
      {
        method: 'PUT',
        path: '/v4/adsp/{adspId}',
        description: 'Update ADSP profile (v4)',
        parameters: ['adspId'],
      },
      {
        method: 'DELETE',
        path: '/v4/adsp/{adspId}',
        description: 'Delete ADSP profile (v4)',
        parameters: ['adspId'],
      },
      { method: 'GET', path: '/v4/adsp/default', description: 'Get default ADSP profile (v4)' },
      {
        method: 'GET',
        path: '/v4/adsp/nametoidmap',
        description: 'Get ADSP profile name to ID map (v4)',
      },
    ],
  },
  {
    ...
    endpoints: [
      ...
      {
        method: 'GET',
        path: '/v3/meshpoints/{meshpointId}',
        description: 'Get mesh point by ID',
        parameters: ['meshpointId'],
      },
      {
        method: 'PUT',
        path: '/v3/meshpoints/{meshpointId}',
        description: 'Update mesh point',
        parameters: ['meshpointId'],
      },
      {
        method: 'DELETE',
        path: '/v3/meshpoints/{meshpointId}',
        description: 'Delete mesh point',
        parameters: ['meshpointId'],
      },
      {
        method: 'GET',
        path: '/v3/meshpoints/{meshpointId}/bssid',
        description: 'Get mesh point BSSIDs',
        parameters: ['meshpointId'],
      },
      {
        method: 'GET',
        path: '/v3/meshpoints/default',
        description: 'Get default mesh point config',
      },
      {
        method: 'GET',
        path: '/v3/meshpoints/profile/default',
        description: 'Get default mesh profile',
      },
      {
        method: 'GET',
        path: '/v3/meshpoints/nametoidmap',
        description: 'Get mesh point name to ID map',
      },
      {
        method: 'GET',
        path: '/v3/meshpoints/tree/{meshpointId}',
        description: 'Get mesh topology tree',
        parameters: ['meshpointId'],
      },
    ],
  },
  {
    ...
    endpoints: [
      ...
      {
        method: 'GET',
        path: '/v1/eguest/{eguestId}',
        description: 'Get EGuest config by ID',
        parameters: ['eguestId'],
      },
      {
        method: 'PUT',
        path: '/v1/eguest/{eguestId}',
        description: 'Update EGuest config',
        parameters: ['eguestId'],
      },
      {
        method: 'DELETE',
        path: '/v1/eguest/{eguestId}',
        description: 'Delete EGuest config',
        parameters: ['eguestId'],
      },
  ...
  },
  {
    ...
    endpoints: [
      ...
      {
        method: 'POST',
        path: '/v1/dpisignatures/custom',
        description: 'Create custom DPI signature',
      },
      {
        method: 'PUT',
        path: '/v1/dpisignatures/custom',
        description: 'Update custom DPI signature',
      },
      {
        method: 'DELETE',
        path: '/v1/dpisignatures/custom',
        description: 'Delete custom DPI signature',
      },
    ],
  },
  {
    ...
    endpoints: [
      {
        method: 'GET',
        path: '/v1/deviceimages/{hwType}',
        description: 'Get firmware images for hardware type',
        parameters: ['hwType'],
      },
    ],
  },
  {
    ...
    endpoints: [
      ...
      {
        method: 'GET',
        path: '/v1/notifications/regional',
        description: 'Get regional notifications',
      },
    ],
  },
  {
    ...
    endpoints: [
      ...
      {
        method: 'PUT',
        path: '/v1/nsightconfig',
        description: 'Update NSight server configuration',
      },
    ],
  },
  {
    ...
    endpoints: [{ method: 'GET', path: '/v1/workflow', description: 'Get workflow status' }],
  },
  {
    name: 'Best Practices',
    icon: Zap,
    ...
    endpoints: [
      {
        method: 'GET',
        path: '/v1/bestpractices/evaluate',
        description: 'Evaluate best practices for the deployment',
      },
      {
        method: 'POST',
        path: '/v1/bestpractices/{id}/accept',
        description: 'Accept a best practice recommendation',
        parameters: ['id'],
      },
    ],
  },
  ...
  },
  {
    ...
    endpoints: [
      {
        method: 'GET',
        path: '/v1/devices/adoptionrules',
        description: 'Get device adoption rules',
      },
      {
        method: 'PUT',
        path: '/v1/devices/adoptionrules',
        description: 'Update device adoption rules',
      },
    ],
  },
];
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="p-4 bg-muted/50 rounded-lg">
              ...
              <code className="text-sm bg-background px-2 py-1 rounded">
                https://&#123;IP_Address&#125;:5825/management
              </code>
            </div>
            <div className="p-4 bg-muted/50 rounded-lg">
                    ...
                    <div className="space-y-2">
                      {category.endpoints.map((endpoint, idx) => (
                        ...
                        >
                          <Badge
                            variant="outline"
                            className={`${getMethodColor(endpoint.method)} font-mono text-xs min-w-[60px] justify-center`}
                          >
                            {endpoint.method}
                          </Badge>
