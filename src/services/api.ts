...
class ApiService {
  ...
  // ============================================================================
  // AP ADOPTION / REGISTRATION SETTINGS
  // XCC's actual adoption surface is the singleton /v1/aps/registration
  // document (EPB-125). The speculative /v1/adoption-rules probes that 404 on
  // every modern controller were removed 2026-09-01; prefer
  ...
  // Guest account CRUD moved to the real CWP ledger (services/guestService.ts →
  // /api/v1/guests → OS-ONE-CWP). The old /v1/guests mock methods were removed
  // 2026-09-01 along with the server.js in-memory guestStore.
