...
import { ROOT_CAUSE_LABELS, ROOT_CAUSE_COLORS, CONFIDENCE_COLORS } from '@/ultr0n/types';
...
export const UltronAnswerCard: React.FC<UltronAnswerCardProps> = ({
  answer,
  onFollowUp,
  onConfirm,
}) => {
  ...
  return (
    <div className="rounded-lg border border-white/10 bg-white/5 p-4 space-y-3">
      ...
      {/* Follow-up chips */}
      <UltronFollowUpChips chips={answer.followUpChips} onSelect={onFollowUp} />
    </div>
  );
};
